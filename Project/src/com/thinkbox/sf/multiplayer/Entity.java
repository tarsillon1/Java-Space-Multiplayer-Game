...
import com.thinkbox.sf.model.Light;
...
public class Entity{
	...
	public Rectangle getRect(){
		return new Rectangle(ModularLocation.convertTileX((int) (x + Game.getInstance().play.map.getDrawX() - ((BufferedImageLoader.converter.getImage(e).getWidth() * scale)  / 2)), tileX), ModularLocation.convertTileY((int) (y + Game.getInstance().play.map.getDrawY() - ((BufferedImageLoader.converter.getImage(e).getHeight() * scale) / 2)), tileY), (int) ((BufferedImageLoader.converter.getImage(e).getWidth() * scale)), (int)((BufferedImageLoader.converter.getImage(e).getHeight() * scale)));
	}
	...
	public void setLight(boolean l, int r, int b){
		light = l;
		setLightR(r);
		setLightB(b);
	}
	...
	public void draw(Graphics g) {
			if (isUser == false) {
				...
				g2d.drawImage(BufferedImageLoader.converter.getImage(e), at,
						null);
				if(light == true){
					Light temp = new Light(x, y, tileX, tileY, lightR, lightB, Images.light);
					temp.draw(g);
				}
			}
