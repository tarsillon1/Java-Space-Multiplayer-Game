...
public class Username {
	...
	public void set(int x, int y, int tx, int ty){
		...
		tileX = tx;
		tileY = ty;
		entity.set(x, y, null, 0, 0, tx, ty, null, true, name, false, false, GameConstants.MAX_INTERVAL, 9, 0, false, Game.getInstance().play.player.getID());
	}
	...
	public void dispose() {
		Game.getInstance().play.names.remove(this);
	}
}
