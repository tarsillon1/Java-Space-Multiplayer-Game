...
public class ResourceLoader {
	...
	public static void loadSounds() {
		AudioPlayer.addSound(Audio.hover, GameConstants.SOUND_LOCATION
				+ "hover.ogg");
		AudioPlayer.addSound(Audio.shoot, GameConstants.SOUND_LOCATION
				+ "shoot.ogg");
		AudioPlayer.addSound(Audio.click, GameConstants.SOUND_LOCATION
				+ "click.ogg");
		AudioPlayer.addSound(Audio.menuMusic, GameConstants.SOUND_LOCATION
				+ "music1.ogg");
		AudioPlayer.addSound(Audio.mainMusic, GameConstants.SOUND_LOCATION
				+ "music2.ogg");
		AudioPlayer.addSound(Audio.mute, GameConstants.SOUND_LOCATION
				+ "mute.ogg");
		AudioPlayer.addSound(Audio.dirtExplosion, GameConstants.SOUND_LOCATION
				+ "dirtExplosion.ogg");
		AudioPlayer.addSound(Audio.moving, GameConstants.SOUND_LOCATION
				+ "moving.ogg");
	}
}
